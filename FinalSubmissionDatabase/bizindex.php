  ...
  <body class="homepage">
    ...
    <div id="header-wrapper">
      ...
      <section id="hero" class="container">
        ...
        promotions.<br>
        <br>
        <a href="#" class="button">Create an Account </a> <a href="#" class="button">Continue
          as a Guest </a> </section>
    </div>
    <!-- Promo -->
...
$sql = "SELECT * FROM BusinessOwner WHERE owner_email = '$email' AND password = '$pass' ";
...
if ($result->num_rows > 0) {
    ...
    header('Location: BusinessOwner.php?email='.$email);
