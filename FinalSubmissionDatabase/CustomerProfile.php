              ...
              <header>
                ...
                <?php
                    ...
                    if($result->num_rows > 0)
                    {
                      ...
                      echo "You have not blacklisted anyone.";
                    }
              ...
              <section>
                ...
                <?php
                    ...
                    if($result = $conn->query($sql3)){
                      ...
                      echo "You have reviewed ".$row['count']." businesses.";
                    } 

/*
                    $test = "SELECT min(number_of_stars) as min
                    FROM Comments, customerCommented
                    WHERE customerCommented.customer_email = '$email' AND customerCommented.comment_number = Comments.comment_number";

                    if($result7 = $conn->query($test)){
                      $row2 = $result7->fetch_assoc();
                      echo "<br>Your lowest rating is ".$row2['min']." stars.";
                    }   
*/
                    $conn->close();
                  ?>
